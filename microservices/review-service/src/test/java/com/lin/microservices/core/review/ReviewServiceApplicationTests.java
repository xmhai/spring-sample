package com.lin.microservices.core.review;
...
import com.lin.microservices.core.review.persistence.ReviewRepository;
...
public class ReviewServiceApplicationTests {
	...
	public void getReviewsMissingParameter() {
		...
		getAndVerifyReviewsByProductId("", BAD_REQUEST)
			.jsonPath("$.path").isEqualTo("/review")
			.jsonPath("$.message").isEqualTo("Bad Arguments"); // Required int parameter 'productId' is not present
	}
